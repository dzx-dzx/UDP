...
class udp_40G_TOP() extends BlackBox {
  val io = new Bundle {
    ...
    val gt_ref_clk_p_40MAC_1 = in Bool ()
    val gt_ref_clk_n_40MAC_1 = in Bool ()
...
class TopLevel extends Component {
  ...
  udp.io.gt_ref_clk_p_40MAC_1 := io.gt_ref_clk_p_40MAC_1
  udp.io.sys_clk_p            := io.sys_clk_p
  udp.io.gt_ref_clk_n_40MAC_0 := !io.gt_ref_clk_p_40MAC_0
  udp.io.gt_ref_clk_n_40MAC_1 := !io.gt_ref_clk_p_40MAC_1
  ...
  udp.io.gt_txp_out_40MAC_1 <> io.gt_txp_out_40MAC_1
  udp.io.gt_txn_out_40MAC_1 <> io.gt_txn_out_40MAC_1

  udp.io.gt_rxp_in_40MAC_0 <> udp.io.gt_txp_out_40MAC_0
  udp.io.gt_rxn_in_40MAC_0 <> udp.io.gt_txn_out_40MAC_0
  udp.io.gt_rxp_in_40MAC_1 <> udp.io.gt_txp_out_40MAC_1
  udp.io.gt_rxn_in_40MAC_1 <> udp.io.gt_txn_out_40MAC_1
      ...
      .doSim(dut => {
        ...
        for (_ <- 0 until 1) {
          fork {
            ...
            dut.io.gt_ref_clk_p_40MAC_1 #= !dut.io.gt_ref_clk_p_40MAC_1.toBoolean
          }
          fork {
